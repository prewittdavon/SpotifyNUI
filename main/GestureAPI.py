...
def DefineGestures():
    ...
    # Thumbs_Up.set_palm((480,230),29)
    # Thumbs_Up.set_finger_pos([(465,78),(470,78)])
    # Thumbs_Up.calc_angles()
    # dict[Thumbs_Up.getName()]=Thumbs_Up
    # # 3. END --------------------------------------#
    # 3. BEGIN ------------------------------------#
    Skip=Gesture("Skip")
    Skip.set_palm((480,230),43)
    Skip.set_finger_pos([(450,63)])
    Skip.calc_angles()
    dict[Skip.getName()]=Skip
    # 3. END --------------------------------------#
    # 3. BEGIN ------------------------------------#
    Back=Gesture("Back")
    Back.set_palm((480,230),43)
    Back.set_finger_pos([(345,200)])
    Back.calc_angles()
    dict[Back.getName()]=Back
    # 3. END --------------------------------------#
    return dict
